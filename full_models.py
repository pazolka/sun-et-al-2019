...
def segnetlite_full(filters):
	...
	conv7 = Conv2DTranspose(128, 3, activation = 'leaky_relu', padding = 'same', kernel_initializer = 'he_normal')(conv6)
	
	merge7 = Concatenate(axis = 3)([conv5,conv7])
	conv8 = Conv2DTranspose(64, 3, activation = 'leaky_relu', padding = 'same', kernel_initializer = 'he_normal')(merge7)

	merge8 = Concatenate(axis = 3)([conv4,conv8])
	conv9 = Conv2DTranspose(64, 3, activation = 'leaky_relu', padding = 'same', kernel_initializer = 'he_normal')(merge8)

	merge9 = Concatenate(axis = 3)([conv3,conv9])
	conv10 = Conv2DTranspose(32, 3, activation = 'leaky_relu', padding = 'same', kernel_initializer = 'he_normal')(merge9)
